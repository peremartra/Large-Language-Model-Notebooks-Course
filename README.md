...
I will create two separate notebooks for this task. One will involve models from OpenAI, and the other will utilize open-source models provided by Hugging Face. The results obtained in the three notebooks are very different. The system works much better with the OpenAI, and LLAMA2 models. 
